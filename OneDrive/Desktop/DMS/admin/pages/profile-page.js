...
function displaySortedStudents(sortedStudents) {
    ...
    for (const className in sortedStudents) {
        ...
        // Add top 10 students for the class
        const topStudents = sortedStudents[className].slice(0, 10);
...
// In the displaySortedStudents function, modify the valuesRow creation:
valuesRow.innerHTML = `
